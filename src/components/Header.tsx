...
const Header = ({
  ...
  const menuState = onMenuToggle
    ? { isMenuOpen, isMenuClosing }
    : { isMenuOpen: localMenuOpen, isMenuClosing: localMenuClosing };
  ...
  return (
    <>
      ...
      <nav
        ...
        style={{
          backgroundColor:
            menuState.isMenuOpen || scrollY > 1200 ? "#F2B522" : "transparent",
          ...
          >
            ...
            >
              <div className="text-white text-center space-y-8 h-full flex flex-col justify-center menu-container">
                <Link
                  to="/about"
                  className="block font-league hover:text-purple-400 transition-colors menu-item"
                >
                  ABOUT US
                </Link>
                <Link
                  to="/impact-program-we-funded"
                  className="block font-league hover:text-purple-400 transition-colors menu-item"
                >
                  OUR PROGRAMS
                </Link>
