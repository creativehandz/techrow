  ...
  const impactVideos = [
    {
      ...
      description:
        "Digital magic that let young creators remix their surroundings and reimagine their world.",
    },
    {
      id: 2,
      ...
      description:
        "Immersive worlds that transported creators into new realities — and let them shape their own.",
    },
    {
      id: 3,
      ...
      description:
        "High-energy gaming that turned community spaces into arenas of excitement, teamwork, and belonging.",
    },
    {
      id: 4,
      src: "/media/videos/pages/thechallagne.mp4",
      ...
      description:
        "Interactive storytelling where students built characters, worlds, and action.",
    },
    {
      id: 5,
      src: "/media/videos/pages/thechallagne.mp4",
      ...
      description:
        "Hands-on creation where imagination moved, lit up, and came alive.",
    },
    {
      id: 6,
      src: "/media/videos/pages/thechallagne.mp4",
      ...
      description:
        "Beats, lyrics, and digital creativity — original tracks crafted with modern tools.",
    },
    {
      id: 7,
      src: "/media/videos/pages/thechallagne.mp4",
      ...
      description:
        "Helping educators bring dynamic, tech-forward experiences into community spaces.",
    },
  ];
        ...
        <div className="container mx-auto text-center responsive-padding">
          ...
          <div className="flex flex-wrap justify-center gap-6 mobile-left-align">
            <button className="impact-button impact-button-pride">
              <img
                src="/media/images/icons/pride.svg"
                alt="Pride icon"
                className="w-auto h-6 prideicon"
              />
            ...
            <button className="impact-button impact-button-pride">
              <img
                src="/media/images/icons/connection.png"
                alt="Connection icon"
                className="w-auto h-6 prideicon"
              />
            ...
            <button className="impact-button impact-button-pride">
              <img
                src="/media/images/icons/safety.png"
                alt="safety icon"
                className="w-auto h-6 prideicon"
              />
              <span>Safety</span>
            ...
            <button className="impact-button impact-button-pride">
              <img
                src="/media/images/icons/creativity.png"
                alt="Creativity makers icon"
                className="w-auto h-6 prideicon"
              />
            ...
            <button className="impact-button impact-button-pride">
              <img
                src="/media/images/icons/opportunity.png"
                alt="Opportunity icon"
                className="w-6 h-6 prideicon"
              />
      ...
      <section className="mission-section-bg footer-bg">
        <div className="container mx-auto">
          ...
          <h2 className="mission-title mb-5">
            This is how entertainment deserts
            <br /> begin to disappear.
          </h2>
