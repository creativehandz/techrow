  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 to-indigo-100">
      ...
      <div
        ...
        style={{ height: "180px", backgroundColor: "#000000" }}
      ></div>
            ...
            <div className="flex flex-col items-center order-2 lg:order-1">
              ...
              <div className="mt-0 max-w-sm">
                <p className="donation-receipt-text text-center">
                  A donation receipt will be emailed to you. Keep a copy for tax
                  purposes. For recurring donations, you'll receive a receipt
                  each month.
                </p>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start justify-center order-1 lg:order-2">
              <div className="impact-content-wrapper">
                ...
                <div className="flex flex-col gap-4 mb-0 mx-auto your-impact-buttons-wrapper">
                  ...
                  <div className="flex gap-4 justify-start lg:justify-center flex-wrap lg:flex-nowrap">
                    <button className="impact-button-new">Pride</button>
                    <button className="impact-button-new">Opportunity</button>
                  ...
                  <div className="flex justify-start lg:hidden">
                    <button className="impact-button-new">Local Makers</button>
                  </div>
              ...
              <div className="mt-6 text-center  mx-auto">
                <p className="tax-info-text">
                  We are a 501(c)3 tax-exempt organization. Your donation is
                  tax-deductible. Keep your email receipt for tax records. You
                  will receive an e-mail after your donation. Questions? Contact{" "}
                  <a
                    href="mailto:info@techrowfund.org"
      ...
      <section className="mission-section-bg footer-bg">
        <div className="container mx-auto">
          <h2 className="mission-title mb-8">Contact us</h2>
